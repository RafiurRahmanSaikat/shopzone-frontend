...
const testimonials = [
  {
    ...
    role: "Verified buyer",
    quote:
      "Fast delivery and the product quality was exactly as described. Smooth checkout!",
  },
  {
    name: "Jordan P.",
    role: "Store owner",
    quote:
      "ShopZone makes it easy to manage orders and build trust with customers.",
  },
  {
    name: "Priya S.",
    role: "Frequent shopper",
    quote:
      "Great prices and a clean experience. I keep coming back for the new drops.",
  },
];
    ...
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-5">
        ...
        <p className="text-sm text-muted-foreground">
          Real feedback from the ShopZone community.
        </p>
      </div>
