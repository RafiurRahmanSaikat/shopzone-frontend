    ...
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-5 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Pick a lane and discover the best of it.</p>
        </div>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {categories.map((category, index) => (
          ...
          >
            <div className={`absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br ${getCategoryColor(index)} blur-2xl`} />
            <div className="relative flex items-center gap-3">
              <div className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${getCategoryColor(index)}`}>
            ...
            <div className="mt-4 flex items-center justify-between">
              <Badge variant="secondary" className="h-6 px-2 text-xs">Shop now</Badge>
