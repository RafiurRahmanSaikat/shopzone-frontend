...
const BentoCard = ({
  ...
  return (
    ...
    >
      {withArrow && (
        <div className="absolute right-2 top-2 z-10 translate-y-4 text-neutral-700 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 dark:text-neutral-300">
          →
        </div>
      )}
      <div
