        ...
        {categories.length > 0 && (
          <div className="mt-2 flex flex-wrap gap-2">
            {categories.map((cat) => (
              <span
                key={cat.id}
                className="rounded-full bg-gray-200 px-2 py-0.5 text-xs text-gray-700 dark:bg-zinc-700 dark:text-gray-200"
              >
                {cat.name}
              </span>
            ))}
...
export default GradintProductCard;
