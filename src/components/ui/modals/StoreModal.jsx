...
//   // Fetch available store categories
//   const { data: categories } = UseFetch("/stores/storeCategory");
//   console.log(categories);
//   // When editing, if initialData is provided, map nested categories to an array of IDs.
//   useEffect(() => {
//     if (initialData) {
...
//       });
//     } else {
//       // Reset the form when no initial data is provided.
//       setFormData({
//         name: "",
//         address: "",
//         location: "",
...
//             className="dark:bg-zinc-00 mt-1 w-full rounded-md border p-2"
//             required
//           />
//         </div>
...
//         {/* Store Categories rendered as checkboxes */}
//         <div>
//           <label className="block text-sm font-medium text-gray-900 dark:text-white">
//             Categories
//           </label>
...
//             type="button"
//             onClick={onClose}
//             className="dark:bg-zinc-00 rounded-md bg-gray-200 px-4 py-2 text-gray-800 hover:bg-gray-300 dark:text-white dark:hover:bg-zinc-600"
//           >
//             Cancel
//           </button>
//           <button
