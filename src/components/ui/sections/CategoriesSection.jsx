    ...
    <Section background="white" className={className} {...props}>
      <Container>
        <div className="mb-12 text-center">
          <Heading>
            Shop by <span className="text-violet-600 dark:text-violet-400">Category</span>
          </Heading>
        ...
        <Grid cols={5} gap={6} className="grid-cols-2 sm:grid-cols-3 md:grid-cols-5">
          {displayCategories.map((category, index) => {
            ...
            return (
              ...
              >
                <div className={`h-40 overflow-hidden bg-gradient-to-br ${categoryInfo.gradient}`}>
