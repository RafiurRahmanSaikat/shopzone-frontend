...
//         {/* Announcement Banner */}
//         {/* <div className="mb-8 flex justify-center">
//           <div className="animate-pulse-slow inline-flex items-center gap-x-2 rounded-full border border-gray-200 bg-white/80 p-2 px-3 text-xs text-gray-600 backdrop-blur-sm transition hover:border-gray-300 dark:border-gray-700 dark:bg-zinc-800/80 dark:text-gray-300">
...
//               <Link
//                 to="/categories"
//                 className="rounded-full bg-white px-8 py-3 text-center text-sm font-medium text-gray-900 shadow-lg transition-all hover:bg-gray-50 focus:ring-2 focus:ring-gray-200 focus:ring-offset-2 focus:outline-none dark:bg-zinc-800 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:focus:ring-offset-gray-900"
//               >
//                 Browse Categories
//               </Link>
//             </div>
...
//             <div className="absolute -bottom-6 -left-6 rounded-xl bg-white/90 p-4 shadow-xl backdrop-blur-sm dark:bg-zinc-800/90">
//               <div className="flex items-center space-x-4">
//                 <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg">
//                   <img
//                     src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1099&q=80"
...
//             <div className="absolute -top-6 -right-6 rounded-xl bg-white/90 p-4 shadow-xl backdrop-blur-sm dark:bg-zinc-800/90">
//               <div className="flex items-center space-x-4">
//                 <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg">
//                   <img
//                     src="https://images.unsplash.com/photo-1585386959984-a4155224a1ad?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
