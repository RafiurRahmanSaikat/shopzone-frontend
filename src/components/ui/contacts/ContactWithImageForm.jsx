      ...
      <div className="container mx-auto px-6 py-10">
        <div className="lg:-mx-10 lg:flex lg:items-center">
          <div className="lg:mx-10 lg:w-1/2">
            ...
            <form className="mt-12">
              <div className="-mx-2 md:flex md:items-center">
                <div className="flex-1 px-2">
                  ...
                  <input
                    ...
                    className="focus:ring-opacity-40 mt-2 block w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 placeholder-gray-400 focus:border-blue-400 focus:ring focus:ring-blue-400 focus:outline-none dark:border-gray-700 dark:bg-zinc-900 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:border-blue-400"
                  />
                </div>
              ...
              <div className="mt-4 w-full">
                ...
                <textarea
                  className="focus:ring-opacity-40 mt-2 block h-32 w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 placeholder-gray-400 focus:border-blue-400 focus:ring focus:ring-blue-400 focus:outline-none md:h-56 dark:border-gray-700 dark:bg-zinc-900 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:border-blue-400"
                  placeholder="Message"
                  defaultValue={""}
                />
              </div>
          ...
          <div className="mt-12 lg:mx-10 lg:mt-0 lg:flex lg:w-1/2 lg:flex-col lg:items-center">
            <img
              className="mx-auto hidden h-1/2 w-1/2 shrink-0 rounded-3xl object-cover lg:block"
              src="/img/house.jpg"
              alt="/img/house.jpg"
            />
