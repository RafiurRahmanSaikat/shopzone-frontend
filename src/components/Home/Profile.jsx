  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        {/* Card */}
        <div className="rounded-xl bg-white p-4 shadow sm:p-7 dark:bg-neutral-800">
          <div className="mb-8">
          ...
          <form>
            ...
            <div className="grid gap-2 sm:grid-cols-12 sm:gap-6">
              <div className="sm:col-span-3">
                <label className="mt-2.5 inline-block text-sm text-gray-800 dark:text-neutral-200">
                  Profile photo
                </label>
              </div>
              {/* End Col */}
              ...
              <div className="sm:col-span-3">
                <label
                  ...
                  className="mt-2.5 inline-block text-sm text-gray-800 dark:text-neutral-200"
                >
                  Full name
                </label>
                <div className="hs-tooltip inline-block">
                  ...
                  <span
                    className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible invisible absolute z-10 inline-block w-40 rounded bg-gray-900 px-2 py-1 text-center text-xs font-medium text-white opacity-0 shadow-sm transition-opacity dark:bg-neutral-700"
                    role="tooltip"
                  >
              ...
              <div className="sm:col-span-9">
                <input
                  id="af-account-email"
                  type="email"
                  className="block w-full rounded-lg border-gray-200 px-3 py-2 pe-11 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
              ...
              <div className="sm:col-span-9">
                <div className="sm:flex">
                  ...
                  />
                  <select className="relative -ms-px -mt-px block w-full border-gray-200 px-3 py-2 pe-9 text-sm shadow-sm first:rounded-t-lg last:rounded-b-lg focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 sm:mt-0 sm:w-auto sm:first:ms-0 sm:first:rounded-s-lg sm:first:rounded-se-none sm:last:rounded-e-lg sm:last:rounded-es-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
              ...
              <div className="sm:col-span-9">
                <textarea
                  id="af-account-bio"
                  className="block w-full rounded-lg border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                  rows={6}
